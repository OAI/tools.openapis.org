...
module.exports = {
   ...
   * @param {number} threshold The "hamming distance" threshold that defines what score is in range
   * @returns {Object} Object containing the property name and to what it should be mapped
   */
  normalisePropertyNames: (sourceProperties, threshold) => {
    const dlThreshold = threshold || 2;
